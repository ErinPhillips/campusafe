...
document.addEventListener("DOMContentLoaded", () => {
    ...
    loginForm.addEventListener("submit", e => {
        ...
        signInWithEmailAndPassword(auth, email, password) // imported firebase method for authentication of credentials - verifies email and passowrd
        // that is stored in authentication tool of firebase
            .then(async (userCredential) => {
                // Signed in
                const uid = userCredential.user.uid; // extract the UID generated by firebase authentication
                // access the users document in database using extracted UID
    ...
    createAccountForm.addEventListener("submit", async e => {
        ...
        //table in firebase
            ...
            const uid = userCredential.user.uid; // extract uid that was generated 
